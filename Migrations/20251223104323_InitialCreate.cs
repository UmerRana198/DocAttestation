        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    CNICHash = table.Column<string>(type: "nvarchar(64)", maxLength: 64, nullable: false),
                    FullName = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    FatherName = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    DateOfBirth = table.Column<DateTime>(type: "datetime2", nullable: false),
                    Gender = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    PhotographPath = table.Column<string>(type: "nvarchar(max)", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    OriginalDocumentPath = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    ...
                    QRTokenExpiry = table.Column<DateTime>(type: "datetime2", nullable: true),
                    IsQRRevoked = table.Column<bool>(type: "bit", nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    EncryptedToken = table.Column<string>(type: "nvarchar(450)", nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_QRVerificationTokens_Applications_ApplicationId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_WorkflowHistory_Applications_ApplicationId",
                        column: x => x.ApplicationId,
                        principalTable: "Applications",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_WorkflowHistory_AspNetUsers_ActionByUserId",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    QRVerificationTokenId = table.Column<int>(type: "int", nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_QRScanLogs_QRVerificationTokens_QRVerificationTokenId",
                        column: x => x.QRVerificationTokenId,
                        principalTable: "QRVerificationTokens",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                });

            migrationBuilder.CreateIndex(
                name: "IX_ApplicantProfiles_CNICHash",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_QRScanLogs_QRVerificationTokenId",
                table: "QRScanLogs",
                column: "QRVerificationTokenId");

            migrationBuilder.CreateIndex(
                name: "IX_QRVerificationTokens_ApplicationId",
                table: "QRVerificationTokens",
                column: "ApplicationId");

            migrationBuilder.CreateIndex(
                name: "IX_QRVerificationTokens_EncryptedToken",
                table: "QRVerificationTokens",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_WorkflowHistory_ActionByUserId",
                table: "WorkflowHistory",
                column: "ActionByUserId");

            migrationBuilder.CreateIndex(
                name: "IX_WorkflowHistory_ApplicationId",
                table: "WorkflowHistory",
                column: "ApplicationId");

            migrationBuilder.CreateIndex(
                name: "IX_WorkflowSteps_ApplicationId",
                table: "WorkflowSteps",
                column: "ApplicationId");
